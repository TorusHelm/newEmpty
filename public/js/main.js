...
function showPass() {
  var link = $('.js-view-pass');
  link.on('click', function () {
    var inp = $(this).siblings();
    var inpType = inp.prop('type');
    inpType === 'password' ? inp.prop('type', 'text') : inp.prop('type', 'password');
  });
}

var windowWidth = $(window).innerWidth(); //переключение табов
...
$(document).ready(function () {
  showPass(); // toggleState('.initHover', '.targetHover', 'mouseenter mouseleave', 'active');
  ...
  eventOutOfElement('.js_outClickDouble, .outClickDouble', 'active', 'mouseup'); //select
